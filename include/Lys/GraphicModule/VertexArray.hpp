...
int LYS_API fn_ShaderDataType_To_Size(ShaderDataType type);
int LYS_API fn_ShaderDataType_To_Type(ShaderDataType type);
...
class LYS_API VertexBufferLayout
{
public:
...
struct LYS_API VertexArray_CreationParams
{
    Mesh* m_Mesh;
};

class LYS_API VertexArray
{
public:
    VertexArray();
