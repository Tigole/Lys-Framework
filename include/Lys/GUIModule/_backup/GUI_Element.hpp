...
public:
    ...
    virtual void mt_On_Update(float elapsed_time);
...
protected:
    ...
    void mt_Add_Style(ElementState state, TextOriginMode x_origin_mode, TextOriginMode y_origin_mode, TextStyle style,
