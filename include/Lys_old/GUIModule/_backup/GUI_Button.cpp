...
{
    mt_Add_Style(ElementState::Neutral, TextOriginMode::Centered, TextOriginMode::Centered, TextStyle::Regular, 30, Color::White,
                 Color::Black, 0.0f, Color(0.1f, 0.2f, 0.7f), Color(0.05f, 0.1f, 0.35f), 10.0f);

    mt_Add_Style(ElementState::Focused, TextOriginMode::Centered, TextOriginMode::Centered, TextStyle::Regular, 30, Color::White,
                 Color::Black, 0.0f, Color(0xff8c00), Color(0xff4500), 10.0f);
